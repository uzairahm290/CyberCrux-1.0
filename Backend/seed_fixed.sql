...
(1, 'web_security', 'Web Security', 'Web application security challenges', 'from-blue-500 to-cyan-500', false),
(2, 'network_security', 'Network Security', 'Network penetration testing scenarios', 'from-green-500 to-emerald-500', false),
(3, 'cryptography', 'Cryptography', 'Encryption and decryption challenges', 'from-yellow-500 to-orange-500', false),
(4, 'forensics', 'Forensics', 'Digital forensics and investigation', 'from-red-500 to-pink-500', false),
(5, 'reverse_engineering', 'Reverse Engineering', 'Binary analysis and malware analysis', 'from-purple-500 to-indigo-500', false),
(6, 'malware_analysis', 'Malware Analysis', 'Malware reverse engineering and analysis', 'from-red-600 to-pink-600', false),
(7, 'social_engineering', 'Social Engineering', 'Human psychology and manipulation techniques', 'from-orange-500 to-red-500', false);
...
(1, 'First Steps', 'Complete your first practice scenario', NULL, 'completion', '{"scenarios_completed": 1}', 10, 'common', true),
(2, 'Streak Master', 'Maintain a 7-day practice streak', NULL, 'streak', '{"streak_days": 7}', 50, 'rare', true),
(3, 'Category Explorer', 'Complete scenarios in 5 different categories', NULL, 'category', '{"categories_completed": 5}', 100, 'epic', true),
(4, 'Tool Master', 'Use 10 different cybersecurity tools', NULL, 'score', '{"tools_used": 10}', 75, 'rare', true),
(5, 'Speed Demon', 'Lightning fast! Complete any scenario in under 5 minutes', NULL, 'time_based', '{"completion_time": 300}', 100, 'rare', true),
(6, 'Night Owl', 'Complete scenarios between 10 PM and 6 AM', NULL, 'time_based', '{"night_hours": true}', 25, 'uncommon', true),
(7, 'Weekend Warrior', 'Complete 5 scenarios in a single weekend', NULL, 'completion', '{"weekend_scenarios": 5}', 150, 'epic', true),
(8, 'Early Bird', 'Complete scenarios between 6 AM and 10 AM', NULL, 'time_based', '{"morning_hours": true}', 25, 'uncommon', true),
(9, 'Perfect Score', 'Get 100% on any scenario', NULL, 'score', '{"perfect_score": true}', 200, 'epic', true),
(10, 'Quick Learner', 'Complete 3 scenarios in one day', NULL, 'completion', '{"daily_scenarios": 3}', 75, 'rare', true),
(11, 'Persistent', 'Attempt a scenario 5 times before completing it', NULL, 'completion', '{"attempts_before_completion": 5}', 50, 'rare', true),
(12, 'Explorer', 'Try scenarios from 3 different categories', NULL, 'category', '{"categories_tried": 3}', 60, 'uncommon', true),
(13, 'Night Shift', 'Complete 3 scenarios after midnight', NULL, 'time_based', '{"midnight_scenarios": 3}', 100, 'rare', true),
(14, 'Morning Person', 'Complete 3 scenarios before noon', NULL, 'time_based', '{"morning_scenarios": 3}', 100, 'rare', true),
(15, 'Weekend Master', 'Complete 10 scenarios in a single weekend', NULL, 'completion', '{"weekend_scenarios": 10}', 300, 'legendary', true),
(16, 'Speed Runner', 'Complete any scenario in under 2 minutes', NULL, 'time_based', '{"completion_time": 120}', 250, 'legendary', true),
(17, 'Marathon Runner', 'Complete scenarios for 5 consecutive days', NULL, 'streak', '{"consecutive_days": 5}', 125, 'epic', true),
(18, 'Ultimate Master', 'Complete 50 scenarios total', NULL, 'completion', '{"total_scenarios": 50}', 500, 'legendary', true);
...
(1, 'The Web Application Hacker''s Handbook', 'Comprehensive guide to web application security testing', 'web_security', 'Dafydd Stuttard', 'web-hackers-handbook.jpg', 'web-hackers-handbook.pdf', 4.8, 500, '8 hours', 800, '2011', true),
(2, 'Network Security Essentials', 'Fundamentals of network security and protocols', 'network_security', 'William Stallings', 'network-security.jpg', 'network-security.pdf', 4.6, 400, '6 hours', 600, '2017', true),
(3, 'Practical Cryptography', 'Real-world cryptography implementation', 'cryptography', 'Niels Ferguson', 'practical-crypto.jpg', 'practical-crypto.pdf', 4.7, 350, '7 hours', 700, '2003', false),
(4, 'Digital Forensics', 'Computer forensics and investigation techniques', 'forensics', 'John Sammons', 'digital-forensics.jpg', 'digital-forensics.pdf', 4.5, 300, '5 hours', 500, '2015', false),
(5, 'Reverse Engineering', 'Software reverse engineering fundamentals', 'reverse_engineering', 'Eldad Eilam', 'reverse-engineering.jpg', 'reverse-engineering.pdf', 4.4, 250, '9 hours', 900, '2005', false);
