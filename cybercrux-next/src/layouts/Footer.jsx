  ...
  return (
    <footer className="relative z-10 w-full bg-black/50 backdrop-blur-3xl border-t border-white/5 shadow-inner shadow-cyan-500/5 flex flex-col sm:flex-row items-center sm:items-center justify-center sm:justify-between gap-2 sm:gap-0 px-2 sm:px-6 py-4">
      ...
      <div className="flex flex-col sm:flex-row gap-1 sm:gap-4 text-xs opacity-80 items-center">
        <Link href="/terms" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200 font-medium">Terms of Use</Link>
        <Link href="/privacy" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200 font-medium">Privacy Policy</Link>
        <Link href="/contact" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200 font-medium">Contact Us</Link>
      </div>
