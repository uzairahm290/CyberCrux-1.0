  ...
  useEffect(() => {
    const fetchLabs = async () => {
      try {
        ...
        const res = await axios.get((process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5555') + "/api/blogs");
                ...
                {lab.icon}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link href={`/labs/${lab.id}`} className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all duration-300 transform hover:scale-105">
                            View Details
                          </Link>
                        </div>
                      </div>
                      ...
                      >
                        <div className="flex items-start gap-6">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <Link href={`/labs/${lab.id}`} className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-lg">
                              View Details
                            </Link>
                          </div>
                        </div>
