  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, activityRes, usersRes, growthRes] = await Promise.all([
        fetch(process.env.NEXT_PUBLIC_API_URL + '/api/admin/dashboard-stats', { credentials: 'include' }),
        fetch(process.env.NEXT_PUBLIC_API_URL + '/api/admin/recent-activity', { credentials: 'include' }),
        fetch(process.env.NEXT_PUBLIC_API_URL + '/api/admin/top-users', { credentials: 'include' }),
        fetch(process.env.NEXT_PUBLIC_API_URL + '/api/admin/user-growth', { credentials: 'include' })
      ]);
