...
export default function BadgesPage() {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const badgesResponse = await fetch(import.meta.env.VITE_API_URL + '/api/badges', {
        credentials: 'include'
      });
      ...
      try {
        ...
        if (authData.success && authData.user) {
          ...
          const userBadgesResponse = await fetch(`${import.meta.env.VITE_API_URL}/api/badges/user/${authData.user.id}`, {
            credentials: 'include'
          });
      ...
      if (!userBadgesData || !userBadgesData.success) {
        try {
          const userBadgesResponse = await fetch(import.meta.env.VITE_API_URL + '/api/badges/user/me', {
            credentials: 'include'
          });
          userBadgesData = await userBadgesResponse.json();
