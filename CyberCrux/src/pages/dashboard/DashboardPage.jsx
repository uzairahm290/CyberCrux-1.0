...
export default function DashboardPage() {
  ...
  const fetchStreakData = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/streak/user-streak/${user.id}`);
  ...
  const fetchUserStats = async () => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/practice/stats', {
        credentials: 'include'
      });
      const data = await response.json();
  ...
  const fetchWeeklyProgress = async () => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/practice/progress', {
        credentials: 'include'
      });
      const data = await response.json();
  ...
  const fetchUpcomingChallenges = async () => {
    try {
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/practice/scenarios');
      const data = await response.json();
  ...
  const recordLogin = async () => {
    ...
    try {
      await fetch(import.meta.env.VITE_API_URL + '/api/streak/record-login', {
        method: 'POST',
