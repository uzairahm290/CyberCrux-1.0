...
const BookPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch books
      const booksResponse = await fetch(import.meta.env.VITE_API_URL + '/api/books');
      ...
      const categoriesResponse = await fetch(import.meta.env.VITE_API_URL + '/api/books/categories');
