  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        const progressResponse = await fetch(import.meta.env.VITE_API_URL + '/api/practice/progress', {
          credentials: 'include'
        });
        ...
        try {
          const statsResponse = await fetch(import.meta.env.VITE_API_URL + '/api/practice/stats', {
            credentials: 'include'
          });
        ...
        try {
          const streakResponse = await fetch(`${import.meta.env.VITE_API_URL}/api/streak/user-streak/${user.id}`);
