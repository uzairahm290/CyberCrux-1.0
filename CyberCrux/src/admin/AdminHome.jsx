  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, activityRes, usersRes, growthRes] = await Promise.all([
        ...
        fetch(import.meta.env.VITE_API_URL + '/api/admin/recent-activity', { credentials: 'include' }),
        fetch(import.meta.env.VITE_API_URL + '/api/admin/top-users', { credentials: 'include' }),
        fetch(import.meta.env.VITE_API_URL + '/api/admin/user-growth', { credentials: 'include' })
      ]);
