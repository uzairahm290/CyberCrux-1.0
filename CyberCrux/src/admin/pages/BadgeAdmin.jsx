...
const BadgeAdmin = () => {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/badges/${editingBadge}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDelete = async (badgeId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/badges/${badgeId}`, {
        method: 'DELETE',
        credentials: 'include'
      });
