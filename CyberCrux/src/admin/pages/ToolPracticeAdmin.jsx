...
const ToolPracticeAdmin = () => {
  ...
  const fetchScenarios = async () => {
    try {
      setLoading(true);
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/tool-practice/scenarios?admin=true');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingScenario 
        ? `${import.meta.env.VITE_API_URL}/api/tool-practice/scenarios/${editingScenario.id}`
        : import.meta.env.VITE_API_URL + '/api/tool-practice/scenarios';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/tool-practice/scenarios/${id}`, {
        method: 'DELETE'
      });
